...
def main(args):
    ...
    model=train(model=model, train_loader=train_loader, valid_loader=valid_loader, criterion=loss_criterion, optimizer=optimizer,device=device,epochs=epochs)
    ...
    test(model=model, test_loader=test_loader, criterion=loss_criterion,device=device)
    
    '''
    TODO: Save the trained model
    '''
    torch.save(model.state_dict(), os.path.join(model_dir,'dogbreedmodel04feb.pt'))
